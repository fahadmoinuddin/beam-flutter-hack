...
class _loginSignupState extends State<LoginSignupPage> {
    ...
    return new Padding(
      ...
      child: SizedBox(
        ...
        child: new RaisedButton(
          ...
          ? new Text(
            'Sign up', style: new TextStyle(fontSize: 20.0, color: Colors.white),
          )
  ...
  Widget _showSecondaryButton() {
    return new FlatButton(
        ...
        ? new Text('Sign up', style: new TextStyle(fontSize: 18.0, fontWeight: FontWeight.w300))
        : new Text('Login', style: new TextStyle(fontSize: 18.0, fontWeight: FontWeight.w300))
    );
  }
